...
#ifndef SIMPLE_C2_IMG_COMPONENT_H_
#define SIMPLE_C2_IMG_COMPONENT_H_
...
void convertYUV420Planar8ToNV12(const uint8_t* srcY,
               int srcStrideY,
               const uint8_t* srcU,
               int srcStrideU,
               const uint8_t* srcV,
...
void convertYUV420Planar8ToNV21(const uint8_t* srcY,
               int srcStrideY,
               const uint8_t* srcU,
               int srcStrideU,
               const uint8_t* srcV,
...
class C2SoftImageComponent
        : public C2Component, public std::enable_shared_from_this<C2SoftImageComponent> {
public:
    explicit C2SoftImageComponent(
            const std::shared_ptr<C2ComponentInterface> &intf);
    virtual ~C2SoftImageComponent();
...
private:
    ...
    public:
        ...
        void setComponent(const std::shared_ptr<C2SoftImageComponent> &thiz);

    protected:
        void onMessageReceived(const sp<AMessage> &msg) override;

    private:
        std::weak_ptr<C2SoftImageComponent> mThiz;
        bool mRunning;
    };
    ...
    uint64_t mPlatformUsage;

    std::vector<int> mBitDepth10HalPixelFormats;
    C2SoftImageComponent() = delete;
};

}  // namespace android

#endif  // SIMPLE_C2_IMG_COMPONENT_H_
